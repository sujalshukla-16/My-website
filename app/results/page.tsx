  ...
  const learningRoadmap = [
    {
      ...
      courses: [
        { name: "Introduction to Machine Learning", provider: "Coursera", duration: "6 weeks" },
    ...
    },
    {
      ...
      courses: [
        { name: "Advanced ML Algorithms", provider: "Udacity", duration: "8 weeks" },
        { name: "Leadership Fundamentals", provider: "LinkedIn Learning", duration: "3 weeks" },
      ],
    },
    {
      ...
      courses: [
        { name: "Cloud Computing with AWS", provider: "AWS Training", duration: "6 weeks" },
        { name: "Data Visualization", provider: "Tableau", duration: "4 weeks" },
      ],
    },
  ]
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-semibold text-lg">{career.match}% Match</span>
                        </div>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-3 gap-4 mb-4">
                      <div>
                        ...
                        <p className="font-semibold text-green-600">{career.salary}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Growth Potential</p>
                        <Badge variant={career.growth === "Very High" ? "default" : "secondary"}>{career.growth}</Badge>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Matching Skills</p>
                        <p className="font-semibold">
                          {career.skills.length} of {formData.selectedSkills.length}
                        </p>
                      </div>
                    </div>
          ...
          <TabsContent value="skills" className="space-y-6">
            <Card className="shadow-lg">
              <CardHeader>
                ...
                <CardDescription>These skills will help you advance in your chosen career path</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card className="mt-8 bg-gradient-to-r from-blue-600 to-green-600 text-white shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Take the first step towards your dream career. Our AI has created a personalized plan just for you.
            </p>
